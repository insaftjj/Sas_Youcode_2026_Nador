...
> Les chaînes sont immuables (immutable), elles ne peuvent pas être modifiées en mémoire.Des méthodes comme .toUpperCase() ne modifient pas la variable d'origine, elles renvoient une nouvelle chaîne.
